...
#define FLOW_SIG_SIZE (132 + FLOW_N_REGS * 4)
...
BUILD_ASSERT_DECL(FLOW_SIG_SIZE == 164 && FLOW_WC_SEQ == 16);
...
BUILD_ASSERT_DECL(FWW_ALL == ((1 << 12) - 1) && FLOW_WC_SEQ == 16);
...
BUILD_ASSERT_DECL(sizeof(struct flow_wildcards) == 144 && FLOW_WC_SEQ == 16);
