                  ...
                  struct match *match)
{
    ...
    /* We do not support GENEVE OPT for now */
    ...
    add_flow_pattern(patterns, RTE_FLOW_ITEM_TYPE_GENEVE, geneve_spec, geneve_mask,
                     NULL);

    memset(&consumed_masks->tunnel.metadata, 0, sizeof consumed_masks->tunnel.metadata);
