                      ...
                      struct dpif_flow_stats *stats, struct ofpbuf *packet)
{
    ...
    while (1) {
        ...
        /* Update the packet */
        odp_execute_actions(NULL, packet, flow_storage, odp_actions->data,
                            odp_actions->size, NULL, NULL);
        ofpbuf_clear(odp_actions);
                               ...
                               struct flow_miss_op *ops, size_t *n_ops)
{
    ...
    LIST_FOR_EACH (packet, list_node, &miss->packets) {
        ...
        xlate_and_recirculate(ofproto, rule, &miss->flow, &flow_storage,
...
static void
execute_recirculate_action(struct action_xlate_ctx *ctx)
{
           ...
           const struct ofpact *ofpacts, size_t ofpacts_len)
{
    ...
    flow = xlate_and_recirculate(ofproto, NULL, flow, &flow_storage,
